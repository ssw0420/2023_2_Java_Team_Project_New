...
//		mainPanel.setLayout(null);
		...
		// 시작 페이지 화면
		JPanel startPage = new BackgroundPanel("C:\\Users\\alscj\\OneDrive\\바탕 화면\\JAVA_UI\\swing\\background\\background.png");
...
//		CreateUser createUserPage = new CreateUser(startPage);
		...
		// 단어 학습 화면
		WordStudy wordStudyPage = new WordStudy(this);
		mainPanel.add(wordStudyPage, "wordStudyPage");
		wordStudyPage.setVisible(false);
		
		
		// 메인 화면
		WordMenu wordMenuPage = new WordMenu(this, wordQuizPage, wordStudyPage);
